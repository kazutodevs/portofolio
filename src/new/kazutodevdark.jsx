        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              <img
                src="https://fxxjfkcjtuuxbrxhfrph.supabase.co/storage/v1/object/sign/MyCode/WhatsApp%20Image%202025-12-30%20at%208.02.51%20AM(2).jpeg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYmMxZWFkMi01NzczLTQ1MzctODUwNS02ZTg3NjRkODAwNTUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNeUNvZGUvV2hhdHNBcHAgSW1hZ2UgMjAyNS0xMi0zMCBhdCA4LjAyLjUxIEFNKDIpLmpwZWciLCJzY29wZSI6ImRvd25sb2FkIiwiaWF0IjoxNzgxODc4NzI4LCJleHAiOjQ2MjAxMTg3Mjh9.wA0zn67H6jHdePqFpQZIrtw-Y3PYymBdMLnPGqMggq0"
...
/* ─── PROJECTS ───────────────────────────────────────────── */
const PROJECTS = [
  { title:"Xalbador Store", type:"Website App",   desc:"Online digital Shop with Payment Gateway. Integrated with Mayar Payment Gateway, allow qris and all method payment", tags:["React Native","Supabase","Express"], img:"https://fxxjfkcjtuuxbrxhfrph.supabase.co/storage/v1/object/sign/MyCode/optimized-05-07%2020-33-08.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYmMxZWFkMi01NzczLTQ1MzctODUwNS02ZTg3NjRkODAwNTUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNeUNvZGUvb3B0aW1pemVkLTA1LTA3IDIwLTMzLTA4LnBuZyIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODE4Nzg0OTQsImV4cCI6NDkwMzk0MjQ5NH0.ZseASsJYGkBJzDb8s_iZSDT82Tm7O9x1Qs-Uo5IpTgo" },
  { title:"CashFlow System", type:"Website",         desc:"Digital CashFlow for tracking transaction with proof image expense.", tags:["Express","JavaScript","React Native"], img:"https://fxxjfkcjtuuxbrxhfrph.supabase.co/storage/v1/object/sign/MyCode/optimized-06-19%2020-52-49.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYmMxZWFkMi01NzczLTQ1MzctODUwNS02ZTg3NjRkODAwNTUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNeUNvZGUvb3B0aW1pemVkLTA2LTE5IDIwLTUyLTQ5LnBuZyIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODE4Nzg1MzMsImV4cCI6NDkwMzk0MjUzM30.IqVFy4IgSx0uf8D8TfIak49-Dl6I8rWo0msrrjZebno" },
  { title:"San Andreas System Server",type:"Game",          desc:"Server San Andreas Multiplayer, integrated with discord and mysql and using pawn script", tags:["PostgreSQL","C++","Pawn"], img:"https://fxxjfkcjtuuxbrxhfrph.supabase.co/storage/v1/object/sign/MyCode/optimized-06-19%2020-54-51.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYmMxZWFkMi01NzczLTQ1MzctODUwNS02ZTg3NjRkODAwNTUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNeUNvZGUvb3B0aW1pemVkLTA2LTE5IDIwLTU0LTUxLnBuZyIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODE4Nzg1NTgsImV4cCI6NDkwMzk0MjU1OH0.T8Wml4jOwlkCGHRkAdh3kiYCdoL6CA0gTWugHtcdTNg" },
  { title:"Animas Chaos", type:"Native Game",  desc:"A Chaos game with anime cute character, can play multiplayer using mirror tools in unity", tags:["C#","Network","Unity"], img:"https://fxxjfkcjtuuxbrxhfrph.supabase.co/storage/v1/object/sign/MyCode/optimized-06-19%2020-56-50.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9jYmMxZWFkMi01NzczLTQ1MzctODUwNS02ZTg3NjRkODAwNTUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNeUNvZGUvb3B0aW1pemVkLTA2LTE5IDIwLTU2LTUwLnBuZyIsInNjb3BlIjoiZG93bmxvYWQiLCJpYXQiOjE3ODE4Nzg1NzYsImV4cCI6NDkwMzk0MjU3Nn0.PZyC7P6LEZsJ3cVFfGJiYZOTIONKq0NmGfnILsPtIf4" },
];
