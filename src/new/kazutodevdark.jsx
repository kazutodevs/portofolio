...
/* ─── PROJECTS ───────────────────────────────────────────── */
const PROJECTS = [
  { title:"FieldMap Mobile", type:"Mobile App",   desc:"Offline-first field data collection with real-time sync on reconnect. Cross-platform iOS and Android.", tags:["React Native","Supabase","SQLite"], img:"https://picsum.photos/seed/kz-fieldmap/800/480" },
  { title:"Dungeon Fragment", type:"Game",         desc:"Procedurally generated dungeon crawler in Unity. 2.3k downloads on itch.io.", tags:["Unity","C#","Procedural Gen"], img:"https://picsum.photos/seed/kz-dungeon/480/480" },
  { title:"Nusantara Runner",type:"Game",          desc:"Endless runner set in Indonesian folklore. Shipped on Android and web.", tags:["Godot 4","GDScript","Firebase"], img:"https://picsum.photos/seed/kz-nusantara/480/400" },
  { title:"Infratrack",      type:"Web Platform",  desc:"Infrastructure monitoring for small DevOps teams. Real-time alerts and log aggregation.", tags:["Next.js","Go","PostgreSQL"], img:"https://picsum.photos/seed/kz-infratrack/800/400" },
];
